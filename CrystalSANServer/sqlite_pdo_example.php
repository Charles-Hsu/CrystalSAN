<?php
    ...
    try {
        ...
        echo 'sqlite:' . getcwd() . '/Accusys/messaging.sqlite3';
        echo '<br>';
        $file_db = new PDO('sqlite:' . getcwd() . '/Accusys/messaging.sqlite3');
        ...
        $update = "UPDATE messages SET title = {$new_title} WHERE datetime(time) > datetime('2012-06-01 15:48:07')";
        // Execute update
