...
- (void)setSelected:(BOOL)selected animated:(BOOL)animated{
    ...
    if(selected)
    {
        ...
        if ([ann.locationType isEqualToString:@"airport"]) {
            ...
            //calloutView = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"CalloutBackground.png"]];
        }
        ...
        [calloutView setFrame:CGRectMake(30, -70, 0, 0)];
        //[calloutView setFrame:CGRectMake(0, 0, 100, 100)];
        ...
        [calloutView sizeToFit];
        //[calloutView setImage:[UIImage imageNamed:@"CalloutBackground.png"]];
